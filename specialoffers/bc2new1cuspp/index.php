<?php 
	...
	if ( $abTesterValues[0][0] == '0' || $abTesterValues[0][0] == '1' ) {
		
		$leadsource .= '_ord_t4v1';
		
	}
	
	else {

		$leadsource .= '_ord_t4v2';
...
<!-- Auto populate email value if is set $_GET["inf_field_Email"] -->
<?php if(isset($_GET["inf_field_Email"])){ ?>
	
	<script>
		var inf_field_Email = "<?php echo $_GET["inf_field_Email"]; ?>";
